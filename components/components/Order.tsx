...
export default function Order() {
  ...
  return (
    <section id="order" style={{ 
      ...
      <div style={{ maxWidth: '42rem', margin: '0 auto', padding: '0 1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '1.5rem', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', width: '100%', maxWidth: '24rem', color: 'rgba(73,0,0,0.4)', fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', fontFamily: 'var(--font-montserrat-var), sans-serif' }}>
