...
export default function Story() {
  return (
    <section id="story" style={{ background: '#f6ddbe', padding: '5rem 0', overflow: 'hidden', position: 'relative' }}>
      <div style={{ maxWidth: '1180px', margin: '0 auto', padding: '0 1.5rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem', alignItems: 'center' }}>
        ...
        <StaggerContainer style={{ display: 'flex', flexDirection: 'column', gap: '0' }} staggerDelay={0.13} type="up">
          <AnimateIn style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }} type="up" delay={0}>
            ...
            <AnimateIn type="up" duration={0.7} delay={0.32}>
              <p style={{ fontSize: '1rem', lineHeight: 1.85, color: 'rgba(73,0,0,0.65)', maxWidth: '420px', fontFamily: 'var(--font-montserrat-var), sans-serif', paddingBottom: '0.5rem' }}>
