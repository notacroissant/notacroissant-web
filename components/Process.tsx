...
export default function Process() {
  ...
  return (
    <section id="process" style={{ background: '#490000', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', minHeight: '80vh', position: 'relative', overflow: 'hidden' }}>
      ...
      <StaggerContainer style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '0', position: 'relative', zIndex: 2 }} staggerDelay={0.14} type="up">
        <AnimateIn style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }} type="up" delay={0}>
          ...
          <AnimateIn type="up" duration={0.7} delay={0.38}>
            <p style={{ fontSize: '1rem', lineHeight: 1.85, color: 'rgba(246,221,190,0.62)', maxWidth: '380px', fontFamily: 'var(--font-montserrat-var), sans-serif' }}>
