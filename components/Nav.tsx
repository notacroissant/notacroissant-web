...
export default function Nav() {
  ...
  return (
    <>
      ...
      >
        <div style={{ maxWidth: '1180px', margin: '0 auto', padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          {/* Logo */}
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 40, background: '#490000', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '2.5rem' }}
          >
            {links.map((link, i) => (
              <motion.a
                key={link.href}
