...
export default function Order() {
  ...
  return (
    <section id="order" style={{ background: C.champagne, padding: '8rem 0', overflow: 'hidden', position: 'relative' }}>
      {/* Ambient glow top */}
      <div style={{
        position: 'absolute',
        top: '-20%',
      ...
      <div style={{ maxWidth: '42rem', margin: '0 auto', padding: '0 2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '0', position: 'relative', zIndex: 1 }}>
